...
public class UI_controller : MonoBehaviour {
	...
	void Update () {
        ...
        //介面元件更動
        GameObject.Find("GUI green bar").GetComponent<GUITexture>().pixelInset = new Rect(120, -40, iBarG_width, 20);
        GameObject.Find("GUI red bar").GetComponent<GUITexture>().pixelInset = new Rect(120, -60, iBarR_width, 20);
